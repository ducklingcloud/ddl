...
<link href="${contextPath}/scripts/bootstrap/css/todc-bootstrap.css" rel="stylesheet"/>	
	<div class= "manageSpaceMain">
			...
			<h3 style="margin-bottom:0">${userName}个人空间（同步版Beta）</h3>		
		...
		<!--  <a href="<vwb:Link context="panApplication" format='url'/>?func=resize">重置空间为6G</a>-->
		</div>
		<p>个人空间（同步版Beta）新推出，初始化空间容量增加至20GB，空间不足5GB时，可手动扩容。</p>
		<p>个人空间（同步版Beta）扩容完全免费，每次扩容，增加10GB。</p>
