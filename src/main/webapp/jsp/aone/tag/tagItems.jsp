...
<fmt:setBundle basename="templates.default" />
	...
	<div id="tagSelector"  class="content-menu readyHighLight0">
		...
		文档导航</p>
		<ul class="ui-navList">
			<li><a class="filter-option single" key="filter" value="all" ><span class="tagTitle">所有文档</span></a></li>
			<li><a class="filter-option single" key="filter" value="untaged" ><span class="tagTitle">无标签文档</span></a></li>
		</ul>
	...
	<div class="innerWrapper">
		<div class="toolHolder readyHighLight2" id="tagQueryHolder">
		...
		<div class="toolHolder light readyHighLight2" >
			...
			<a class="addShortcut readyHighLight3" id="top-AddShortcut" title="添加推荐阅读" style="display: none;"></a>
		</div>
		...
		<div id="resourceList-header" class="toolHolder light">
			...
			<div class="ui-RTCorner">
				...
				<ul id="orderDoc" class="switch" style="float:left;">
					<li id="orderDate" class="chosen"><a style="padding:1px 0.5em;">按时间<span class="iconLynxTag icon-arrowdown"></span></a></li>
					<li id="orderTitle"><a style="padding:1px 0.5em;">按标题<span class="iconLynxTag icon-arrowdown"></span></a></li>
				</ul>
		...
		<ul id="resourceList" class="asTable readyHighLight1">
		</ul>
		
		<div class="ui-clear"></div>
		
		<p id="notice" class="NA large  readyHighLight1">正在载入...</p>
		<div id="no-result-helper" class="NA" style="display:none;">
			<!-- <p>您可以：</p> -->
			<ul style="font-size:1.1em; line-height:2em;">
				<li><a
					href="javascript:addResource('<vwb:Link format='url' context='quick'/>?func=createPage')">
						<span class="iconLynx icon-page hover"></span> 新建页面
				</a></li>
				<li><a
					href="javascript:addResource('<vwb:Link format='url' context='quick'/>?func=uploadFiles&bid=0')">
						<span class="iconLynx icon-upload hover"></span> 上传文件和图片
				</a></li>
			</ul>
		</div>
		...
		<div id="resourceAction" class="shadeConsole">
			<ul id="resAction">
				<li id="resAction-list"><a>选中<span class="resCount">0</span>个文档
				...
				<li id="resAction-export"><a><span class="resAction-export"></span>导出</a></li>
				<li id="resAction-view"><a><span class="resAction-view"></span>打开</a></li>
				<li id="toolDelete"><a><span class="resAction-delete"></span>删除</a></li>
			</ul>
		</div>
		<div id="resAction-listMenu" class="pulldownMenu" style="position:fixed;">
			<ul></ul>
			<a id="clearSelection" >清除选择</a>
			<!-- <a id="deleteSelected" class="icon13 icon-trash" title="删除选中的文档"></a> -->
		</div>
		<div id="resAction-exportMenu" class="pulldownMenu" style="position:fixed;">
			<ul>
				<li><a id="export-zip">导出为ZIP</a></li>
				<li><a id="export-epub">导出为Epub</a></li>
			</ul>
		</div>
		<div class="ui-dialog" id="delete-resource-dialog" style="width: 400px;">
			<p class="ui-dialog-title">删除资源</p>
			<p>您真的要删除这些资源吗？</p>
			<p style="color: red">提示：该操作将永久性删除以下资源，且无法恢复！</p>
			<div style="max-height:300px; overflow:auto;"><ul id="delete-resource-list"></ul></div>
			<div class="ui-dialog-control">
				<input type="submit" value="删除" id="delete-resource-submit"/> 
				<a id="delete-cancel" name="cancel">取消</a>
			</div>
		</div>
		<div  class="ui-dialog" id="pageLockErrorMessageDialog" style="width: 400px;">
			<p class="ui-dialog-title">操作冲突</p>
			<p id="pageLockErrorMessageDialogContent" style="padding:1em 0"></p>
		</div>
		...
		<div class="ui-dialog" id="delete-error-msg-dialog" style="width: 400px;">
			<p class="ui-dialog-title">删除消息</p>
			<p id="deleteMsg"></p>
			<div class="ui-dialog-control"></div>
		</div>
		...
		<div id="addSingleTagDialog" class="lynxDialog" style="top:10%">
			...
			<div class="control largeButtonHolder">
				<button class="saveThis">保存</button>
				<button class="closeThis">取消</button>
			</div>
		</div>
