...
<li class='files-item element-data' >
	...
	<div class='version-col col'>
		<span class="time">{{= modofyTime}}</span>
		<span class="size">
...
createNew: function(opt){
	...
	//列表项单击事件
	$("li.files-item").die().live('click',function(){
		var item = _getItemData($(this).find(".rlist-item"));
	...
	var opt = {
		...
		clickItem: function(data){
			if(data.itemType=="Folder"){
				...
				window.location = SHARE_URL+"?rid="+data.rid;
			}
		}
	};
