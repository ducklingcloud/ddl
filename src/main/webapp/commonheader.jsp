...
request.setAttribute("requestScheme",request.getHeader("x-forwarded-proto")==null ? request.getScheme() : request.getHeader("x-forwarded-proto"));
%>
...
<link rel="stylesheet" href="${contextPath}/jsp/aone/css/header-arrow.css" type="text/css" />
...
<script type="text/javascript" src="${contextPath}/scripts/ajax/ajax.js?v=<%=aoneVersion%>"></script>
<script type="text/javascript" src="${contextPath}/scripts/jquery.attachmenu.js"></script>
...
<script type="text/javascript" src="${contextPath}/jsp/aone/js/uiLib-jQuery.js?v=<%=aoneVersion%>"></script>
<script type="text/javascript" src="${contextPath}/jsp/aone/js/header-arrow.js"></script>
<script type="text/javascript">
