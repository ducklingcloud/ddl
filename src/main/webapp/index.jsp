...
<html>
	...
	<div id="index-carousel-1" class="ddl-detail ddl-intro index index-carousel">
		...
		<div class="left-intro">
		    ...
		    <p>适合个人，机构，项目团队，中小企业，社团组织等使用。可用于文档资料共享<br />和管理，即时沟通交流和移动办公。提升团队协作效率。</p>
	...
	<div class="ddl-detail ddl-detail-second pink index-carousel" id="index-carousel-2" style="display:none">
		...
		<div class="left-intro">
		    <h2>安全可靠的云存储服务</h2>
		    <p>个人空间无上限，免费创建多个团队空间。您可以放心的将文档资料上传至云端，轻松<br />管理和共享文档。注重文档协作，支持在线预览、协作编辑、版本管理、讨论和动态消<br />息，让文档协作简单高效！</p>
		    <p class="ddl-active-info"></p>
		</div>
	    </div>
	</div>
	...
	<div class="ddl-detail ddl-detail-second yellow index-carousel" id="index-carousel-3" style="display:none">
		...
		<div class="left-intro">
		    <h2>高效的沟通和交流</h2>
		    <p>团队动态、消息通知帮助成员了解最新的工作进展；在线评论和分享通知，帮助团队<br />头脑风暴，快速有效的沟通。</p>
		    <p class="ddl-active-info"></p>
		</div>
	    </div>
	</div>
	...
	<div class="ddl-detail ddl-detail-second green index-carousel" id="index-carousel-4" style="display:none">
		...
		<div class="left-intro">
		    <h2>多客户端随时随地移动工作</h2>
		    <p>告别U盘吧！无论您身处何地，您都可以使用我们的网页端、PC客户端、手机端轻松<br />共享资源，快速进行协作，体验移动工作的美妙。</p>
		    <p class="ddl-active-info"></p>
		</div>
	    </div>
	</div>
	...
	<div class="ui-wrap" style="position:relative;">
		...
		<p><a id="ddl-regist" class="login-regist" href="https://ddl.escience.cn<vwb:Link context='regist' format='url'/>">免费注册</a></p>
	...
	<div class="downloadDiv">
		...
		<div class="leftText">
		    ...
		    <p><a class="btn btn-large btn-success" href="${contextPath}/download.jsp" target="_blank">查看更多客户端下载</a></p>
		</div>
		<div class="rightImg">
	...
	<div class="featureDiv">
		...
		<h1>用心做好产品</h1>
		<ul>
		    <li style="margin-left:10px"><a href="${contextPath}/ddlFeature.jsp#featureDetail-1" target="_blank"><span class="feature feature-1"></span>文档云存储<br><span class="sub_hint">提供方便快捷搜索，迅速定位所需文档。</span></a></li>
		    <li><a href="${contextPath}/ddlFeature.jsp#featureDetail-2" target="_blank"><span class="feature feature-2"></span>专属团队空间<br><span class="sub_hint">可添加多个成员并给每个成员设置权限。</span></a></li>
		    <li><a href="${contextPath}/ddlFeature.jsp#featureDetail-3" target="_blank"><span class="feature feature-3"></span>支持协作编辑<br><span class="sub_hint">提供完整的版本记录，不必担心文档丢失。</span></a></li>
		    <li><a href="${contextPath}/ddlFeature.jsp#featureDetail-5" target="_blank"><span class="feature feature-4"></span>移动工作<br><span class="sub_hint">支持Windows   Mac   Linux Andriod iPhone</span></a></li>
		    <li><a href="${contextPath}/ddlFeature.jsp#featureDetail-4" target="_blank"><span class="feature feature-5"></span>高效交流<br><span class="sub_hint">提供文档评论和@功能，减少邮件流转。</span></a></li>
		    <li style="margin-right:10px"><a href="${contextPath}/ddlFeature.jsp#featureDetail-6" target="_blank"><span class="feature feature-6"></span>多客户端同步<br><span class="sub_hint">让你告别U盘时代，多台电脑时刻同步文件。</span></a></li>
		</ul>
	    </div>
	</div>
