...
<head>
	...
	<title>常见邮件客户端软件地址簿文件的导出方法 - Outlook Express - 科研在线</title>
		...
		<div id="content">
			<div class="content-title tutorial">
						<ul class="titleDivide addressbook" id="mailHelper">
							...
							<li id="expressTab"  class="current"><a>Outlook Express</a></li>
							<li id="thunderbirdTab" ><a href="thunderbirdImportHelper.jsp">Thunderbird</a></li>
						</ul>
			</div>
			<div id="express" class="content-through sub">
			...
			<ol>
				<li>
					<div class="text">首先打开Outlook Express软件，点击“文件”->“导出”；</div>
					<div class="img"><img src="${contextPath}/images/mailhelper/express/csv/step1.png"/></div>
					<div class="ui-clear"></div> 
				</li>
				<li>
					<div class="text">选择“文本文件（以逗号分隔）”，然后点击“导出”；</div>
					<div class="img"><img src="${contextPath}/images/mailhelper/express/csv/step2.png"/></div>
					<div class="ui-clear"></div> 
				</li>
				<li>
					<div class="text">选择您要保存*.csv文件的路径，然后点击“下一步”；</div>
					<div class="img"><img src="${contextPath}/images/mailhelper/express/csv/step3.png"/></div>
					<div class="ui-clear"></div> 
				</li>
				<li>
					<div class="text">选择您需要导出的联系人字段信息，一般默认只导出“姓名”和“电子邮件地址”信息。接着点击“完成”按钮即可完成导出操作。</div>
					<div class="img"><img src="${contextPath}/images/mailhelper/express/csv/step4.png"/></div>
					<div class="ui-clear"></div> 
				</li>
				<li>
			...
			<div class="vcf" style="display:none;">
				<ol>
					<li>
						<div class="text">首先打开Outlook Express软件，点击“工具”->“通讯簿”；</div>
						<div class="img"><img src="${contextPath}/images/mailhelper/express/vcf/step1.png"/></div>
						<div class="ui-clear"></div>
					</li>
					<li>
						<div class="text">选中需要导出的联系人，点击“文件”->“导出”->“名片（vCard）”；</div>
						<div class="img"><img src="${contextPath}/images/mailhelper/express/vcf/step2.png"/></div>
						<div class="ui-clear"></div>
					</li>
					<li>
						<div class="text">选择您要保存*.vcf文件的路径，点击“保存”即可完成导出操作；</div>
						<div class="img"><img src="${contextPath}/images/mailhelper/express/vcf/step3.png"/></div>
						<div class="ui-clear"></div>
					</li>
					<li>
