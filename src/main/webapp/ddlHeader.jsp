...
<link href="${escienceDomain }/dface/css/dface.banner.css" rel="stylesheet" type="text/css"/>
<style>
...
<script src="${escienceDomain }/dface/js/dface.banner.js" type="text/javascript" ></script>
<div class="navbar navbar-fixed-top">
	<div class="navbar-inner">
		<div class="container">
			<div class="nav-collapse collapse">
				<div class="brand ddl-logo" id="macroNav">
					<a title="科研在线-团队文档库" id="logo"><b class="caret"></b></a>
				</div>
				<ul class="nav-right" id="login">
					<!-- <li>服务热线：010-58812312</li> -->
