...
function FCKContextMenu_AttachedElement_OnContextMenu(ev, fckContextMenu, el) {
	...
	var pos = FCKContextMenu_EventPos(ev);
	fckContextMenu._Panel.Show(pos.x, pos.y, ev.currentTarget || null);

	return false;
}
function FCKContextMenu_EventPos(ev){
	if (FCKBrowserInfo.IsSafari && !FCKBrowserInfo.IsChrome)
