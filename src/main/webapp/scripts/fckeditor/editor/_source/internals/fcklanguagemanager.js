...
var FCKLanguageManager = FCK.Language = {
	...
	Initialize : function() {
		...
		// add by diyanliang 09-9-02 for i18n
		var arr = FCKConfig.DucklingLocales;
		if (this.AvailableLanguages[arr] == undefined) {
			arr = "en-us";
		}
		this.ActiveLanguage.Code = arr;
		this.ActiveLanguage.Name = this.AvailableLanguages[arr];
		// end
	}
};
