...
FCKXHtml._AppendAttributes = function(xmlNode, htmlNode, node, nodeName) {
	var aAttributes = htmlNode.attributes, bHasStyle = false;
...
//AA
		...
		var I = FCKTools.ProtectFormStyles(htmlNode);
		var J = htmlNode.style.cssText.replace(FCKRegexLib.StyleProperties,
				FCKTools.ToLowerCase);
		FCKTools.RestoreFormStyles(htmlNode, I);
		this._AppendAttribute(node, "style", J);
	}
}
