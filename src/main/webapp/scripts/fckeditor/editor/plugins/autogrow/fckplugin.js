...
function FCKAutoGrow_Check()
{
	...
	if ( iDiff != 0 )
	{
		...
		iMainFrameSize=iMainFrameSize+20;
		if (of.style.height) { 
...
function FCKAutoGrow_SetListeners()
{
	if ( FCK.EditMode != FCK_EDITMODE_WYSIWYG )
		return ;
	FCKTools.AddEventListener(FCK.EditorWindow, 'scroll', FCKAutoGrow_Check);
	FCKTools.AddEventListener(FCK.EditorDocument, 'keyup', FCKAutoGrow_Check);
}
