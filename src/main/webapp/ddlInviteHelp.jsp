...
<html>
	...
	<div class="ui-wrap">
		...
		<div id="ddl-tagHelp">
		    <p>创建团队后，管理员可以通过点击团队名称右侧的管理按钮，邀请他人加入自己的团队。文档库将向受到邀请的人发送带有邀请链接的电子邮件，他们通过该链接注册文档库并加入团队。如果被邀请人已经是文档库用户，他们将在系统中收到通知消息。</p>
		    ...
		    <p>被邀请人的邮箱将收到邮件，若同意加入团队，点击该邮件中的链接即可。</p>
