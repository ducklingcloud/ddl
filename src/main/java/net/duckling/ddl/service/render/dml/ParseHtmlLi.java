 ...
 */
public class ParseHtmlLi extends AbstractParseHtmlElement {

    private static final Logger LOG = Logger.getLogger(ParseHtmlLi.class);
    ...
    public void printElement(Element e,Html2DmlEngine html2dmlengine ){
        html2dmlengine.getMout().print("<li");
        ...
        if(html2dmlengine.getPreType()>0){
            ...
            html2dmlengine.getMout().println("</li>");
        }
    }
}
