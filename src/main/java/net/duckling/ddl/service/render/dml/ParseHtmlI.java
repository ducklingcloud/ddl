 ...
 * @author 狄
 */
public class ParseHtmlI extends AbstractParseHtmlElement {

	private static final Logger LOG = Logger.getLogger(ParseHtmlI.class);
	...
	public void printElement(Element e,Html2DmlEngine html2dmlengine ){
		html2dmlengine.getMout().print("<i");
		...
		if(html2dmlengine.getPreType()>0){
			...
			html2dmlengine.getMout().println("</i>");
		}
