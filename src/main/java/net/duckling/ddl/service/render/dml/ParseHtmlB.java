 ...
 * @author 狄
 */
public class ParseHtmlB extends AbstractParseHtmlElement {

    private static final Logger LOG = Logger.getLogger(ParseHtmlB.class);
    ...
    public void printElement(Element e ,Html2DmlEngine html2dmlengine){
        html2dmlengine.getMout().print("<b");
        ...
        if(html2dmlengine.getPreType()>0){
            ...
            html2dmlengine.getMout().println("</b>");
        }
