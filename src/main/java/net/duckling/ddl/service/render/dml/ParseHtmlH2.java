 ...
 * @author 狄
 */
public class ParseHtmlH2 extends AbstractParseHtmlElement {

    private static final Logger LOG = Logger.getLogger(ParseHtmlH2.class);
    ...
    public void printElement(Element e,Html2DmlEngine html2dmlengine ){
        html2dmlengine.getMout().print("<h2");
        ...
        if(html2dmlengine.getPreType()>0){
            ...
            html2dmlengine.getMout().println("</h2>");
        }
    }
