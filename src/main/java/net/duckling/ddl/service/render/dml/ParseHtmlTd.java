 ...
 */
public class ParseHtmlTd extends AbstractParseHtmlElement {

	private static final Logger LOG = Logger.getLogger(ParseHtmlTd.class);
	...
	public void printAttribute(Element e,Html2DmlEngine html2dmlengine) {
         ...
         map.put( "rowspan", e.getAttributeValue( "rowspan" ) );                    
         map.put( "colspan", e.getAttributeValue( "colspan" ) );
         map.put( "nowrap", e.getAttributeValue( "nowrap" ) );                    
         ...
         map.put( "valign", e.getAttributeValue( "valign" ) ); 
         map.put( "align", e.getAttributeValue( "align" ) ); 
         map.put( "background", e.getAttributeValue( "background" ) );
	...
	public void printElement(Element e,Html2DmlEngine html2dmlengine ){
		html2dmlengine.getMout().print("<td");
		...
		if(html2dmlengine.getPreType()>0){
			...
			html2dmlengine.getMout().println("</td>");
		}
	}
}
