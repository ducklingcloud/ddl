 ...
 */
public class ParseHtmlTfoot extends AbstractParseHtmlElement {

	private static final Logger LOG = Logger.getLogger(ParseHtmlTfoot.class);
	...
	public void printElement(Element e,Html2DmlEngine html2dmlengine ){
		html2dmlengine.getMout().print("<tfoot");
		...
		if(html2dmlengine.getPreType()>0){
			...
			html2dmlengine.getMout().println("</tfoot>");
		}
	}
