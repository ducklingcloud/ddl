 ...
 * @author 狄
 */
public class ParseHtmlH3 extends AbstractParseHtmlElement {

    private static final Logger LOG = Logger.getLogger(ParseHtmlH3.class);
    ...
    public void printElement(Element e,Html2DmlEngine html2dmlengine ){
        html2dmlengine.getMout().print("<h3");
        ...
        if(html2dmlengine.getPreType()>0){
            ...
            html2dmlengine.getMout().println("</h3>");
        }
    }
}
