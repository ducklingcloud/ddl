 ...
 */
public class ParseHtmlSub extends AbstractParseHtmlElement {

    private static final Logger LOG = Logger.getLogger(ParseHtmlSub.class);
    ...
    public void printElement(Element e,Html2DmlEngine html2dmlengine ){
        html2dmlengine.getMout().print("<sub");
        ...
        if(html2dmlengine.getPreType()>0){
            ...
            html2dmlengine.getMout().println("</sub>");
        }
    }
