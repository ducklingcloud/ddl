 ...
 */
public class ParseHtmlThead extends AbstractParseHtmlElement {

	private static final Logger LOG = Logger.getLogger(ParseHtmlThead.class);
	...
	public void printElement(Element e,Html2DmlEngine html2dmlengine ){
		html2dmlengine.getMout().print("<thead");
		...
		if(html2dmlengine.getPreType()>0){
			...
			html2dmlengine.getMout().println("</thead>");
		}
	}
