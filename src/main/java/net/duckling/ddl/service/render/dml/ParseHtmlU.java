 ...
 */
public class ParseHtmlU extends AbstractParseHtmlElement {

    private static final Logger LOG = Logger.getLogger(ParseHtmlU.class);
    ...
    public void printElement(Element e,Html2DmlEngine html2dmlengine ){
        html2dmlengine.getMout().print("<u");
        ...
        if(html2dmlengine.getPreType()>0){
            ...
            html2dmlengine.getMout().println("</u>");
        }
