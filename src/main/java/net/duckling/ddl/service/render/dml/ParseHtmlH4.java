 ...
 * @author 狄
 */
public class ParseHtmlH4 extends AbstractParseHtmlElement {
	
	private static final Logger LOG = Logger.getLogger(ParseHtmlH4.class);
	...
	public void printElement(Element e,Html2DmlEngine html2dmlengine ){
		html2dmlengine.getMout().print("<h4");
		...
		if(html2dmlengine.getPreType()>0){
			...
			html2dmlengine.getMout().println("</h4>");
		}
	}
