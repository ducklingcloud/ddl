 ...
 */
public class ParseHtmlStrike extends AbstractParseHtmlElement {

    private static final Logger LOG = Logger.getLogger(ParseHtmlStrike.class);
    ...
    public void printElement(Element e,Html2DmlEngine html2dmlengine ){
        html2dmlengine.getMout().print("<strike");
        ...
        if(html2dmlengine.getPreType()>0){
            ...
            html2dmlengine.getMout().println("</strike>");
        }
    }
